        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <Link
              ...
              className={`text-lg font-light hover:text-yellow-300 hover:font-bold ${
                location.pathname === "/"
          ...
          <div className="hidden md:flex items-center">
            ...
            <Link
              to="/signup"
              className="ml-2 bg-yellow-400 text-slate-800 px-4 py-1 rounded-md text-sm font-medium hover:bg-yellow-300"
            >
              Signup
            </Link>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden mt-2 space-y-2 pb-4">
            ...
            <div className="mt-2">
              ...
              <Link
                to="/login"
                className="block mt-2 bg-yellow-400 text-slate-800 px-4 py-1 rounded-md text-sm text-center font-medium hover:bg-yellow-300"
              >
                Login
              </Link>
              <Link
