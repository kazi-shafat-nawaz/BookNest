...
const handleSearch = () => {
    ...
    return (
        <div className="bg-gray-200 shadow-lg rounded-xl p-4 max-w-6xl mx-auto -mt-40 z-10 relative">
      <div className="flex flex-col md:flex-row items-stretch gap-4">
        ...
        <button
          ...
          className="bg-blue-600 text-white font-semibold rounded-lg px-6 py-2 hover:bg-blue-500 self-center"
        >
          Search
        </button>
      </div>
